...
class ConvLayerController(nn.Module):
    ...
    def __init__(self, embed_dim=512, depth=4, num_heads=4, mlp_ratio=4, num_modalities = 2, total_layers=6):
        ...
        #         nn.ReLU(),
        #         nn.Conv2d(in_channels=6, out_channels=24, kernel_size=(10, 10)),
        #         nn.BatchNorm2d(num_features=24),
        #         nn.ReLU(),
        #         nn.Conv2d(in_channels=24, out_channels=24, kernel_size=(10, 10)),
        #         nn.BatchNorm2d(num_features=24),
        #         nn.ReLU(),
        #         nn.Conv2d(in_channels=24, out_channels=24, kernel_size=(10, 10)),
        #         nn.BatchNorm2d(num_features=24),
        #         nn.ReLU(),
        #         nn.MaxPool2d((2, 2)),
        #         nn.Conv2d(in_channels=24, out_channels=3, kernel_size=(5, 5)),
        #         nn.ReLU(),
        #         nn.Flatten(1, -1),
        #         nn.Linear(2352, embed_dim)
        #     ),
        #     'audio': nn.Sequential(
