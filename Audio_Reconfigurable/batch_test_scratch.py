...
def main(args):
    ...
    model = GTDM_Early(args.adapter_hidden_dim, valid_mods=args.valid_mods, total_layers=args.total_layers, vision_vit_layers=args.vit_layers_img, audio_vit_layers=args.vit_layers_audio) # Pass valid mods, nodes, and also hidden layer size
    # Load model weights
    ...
    testset = AVE_Dataset('./test_datasets/' + args.test_type + '/', args.valid_mods)
