...
from models.GTDM_Model import Conv_GTDM_Controller, AdaMML_Model_All
...
def main(args):
    ...
    for epoch in trange(args.num_epochs, desc="Training"):
        ...
        for batch in train_dataloader:
            ...
            batch_results, selector_out = model(data) #Dictionary
            print("modality selection result:", selector_out)
