    ...
    def __init__(self, adapter_hidden_dim, valid_mods, valid_nodes, drop_layers_img = None, drop_layers_depth=None, 
        ...
        if 'zed_camera_left' in valid_mods:
            ...
            if vision_vit_layers == 12 and not from_scratch:
                print(self.vision.load_state_dict(torch.load('/mnt/ssd_8t/jason/Noisy_Dataset_Cache/MAE_Dropout_FT_Dropout.pth')['model'], strict=False))
        ...
        if 'realsense_camera_depth' in valid_mods:
            ...
            if depth_vit_layers == 12 and not from_scratch:
                print(self.depth.load_state_dict(torch.load('/mnt/ssd_8t/jason/Noisy_Dataset_Cache/MAE_Dropout_FT_Dropout.pth')['model'], strict=False))
