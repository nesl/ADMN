...
from PickleDataset import AVE_Dataset, transform_mask, transform_noise, transform_finite_noise, transform_set_noise, transform_discrete_noise
...
def main(args):
    ...
    model = Conv_AVE_Controller(args.adapter_hidden_dim, valid_mods=args.valid_mods, valid_nodes = args.valid_nodes, total_layers=args.total_layers) # Pass valid mods, nodes, and also hidden layer size
    # Load model weights
