...
Train the controller with no supervision (AE or noise loss)
See whether the controller can learn to differentiate certain samples based on the noise
...
def main(args):
    ...
    dt_string = 'Unsupervised_Controller_Layer_' + str(args.total_layers) + '_Seed_' + str(args.seedVal)
