...
class AVE_Early(nn.Module):
    def __init__(self, adapter_hidden_dim, valid_mods, drop_layers_img = None, drop_layers_audio=None, 
                 layerdrop=0.0, vision_vit_layers=12, audio_vit_layers=12, from_scratch=False):
        super(AVE_Early, self).__init__()
...
class Conv_AVE_Controller(nn.Module):
    ...
    def __init__(self, adapter_hidden_dim, valid_mods, total_layers=8):
        super(Conv_AVE_Controller, self).__init__()
...
# Full Stage 2 Model with Controller
class Conv_AVE_Controller_Unequal(nn.Module):
    # Total layers establishes the layer budget that is provided to the controller
    def __init__(self, adapter_hidden_dim, valid_mods, total_layers=8):
        super(Conv_AVE_Controller_Unequal, self).__init__()
