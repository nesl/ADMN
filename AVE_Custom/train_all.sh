...
# python3 train.py --vision_vit_layers 3 --audio_vit_layers 3 --max_layerdrop 0 --num_epochs 200
# python3 train.py --vision_vit_layers 4 --audio_vit_layers 4 --max_layerdrop 0 --num_epochs 200
# python3 train.py --vision_vit_layers 6 --audio_vit_layers 6 --max_layerdrop 0 --num_epochs 200
# python3 train.py --vision_vit_layers 8 --audio_vit_layers 8 --max_layerdrop 0 --num_epochs 200
