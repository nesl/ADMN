...
def get_args_parser():
    ...
    parser.add_argument("--cached_root", type=str, default = cached_root)
...
def main(args):
    ...
    model = Conv_AVE_Controller_Unequal(args.adapter_hidden_dim, valid_mods=args.valid_mods, total_layers=args.total_layers) # Pass valid mods, nodes, and also hidden layer size
    # Load model weights
    ...
    testset = PickleDataset(data_root = '/mnt/ssd_8t/redacted/AVE_Dataset_Cached/', type='test', valid_noise_types=[1, 2])
