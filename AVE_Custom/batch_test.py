...
def get_args_parser():
    ...
    parser.add_argument('--drop_layers_img', type=int, nargs='+',  help='Dropped layer config for Img')
    parser.add_argument('--drop_layers_audio', type=int, nargs='+', help='Dropped layer config for Audio')
